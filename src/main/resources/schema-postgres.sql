...
CREATE TABLE cshop.address (id BIGSERIAL NOT NULL, adds CHARACTER VARYING(1024) NOT NULL, city CHARACTER VARYING(256) NOT NULL, fio CHARACTER VARYING(256) NOT NULL, phone_number CHARACTER VARYING(32) NOT NULL, postcode CHARACTER VARYING(16) NOT NULL, region CHARACTER VARYING(64) NOT NULL, PRIMARY key (id));
...
CREATE TABLE cshop.product_type (id BIGSERIAL NOT NULL, name CHARACTER VARYING(64) NOT NULL, img OID NOT NULL, PRIMARY key (id));
CREATE TABLE cshop.provider (id BIGSERIAL NOT NULL, name CHARACTER VARYING(256) NOT NULL, PRIMARY key (id));
CREATE TABLE cshop.sale (id BIGSERIAL NOT NULL, last_update_date TIMESTAMP, sale_date TIMESTAMP, status INTEGER NOT NULL, address_id BIGINT, buyer_id BIGINT NOT NULL, seller_id BIGINT, PRIMARY key (id));
...
CREATE TABLE cshop.supply (id BIGSERIAL NOT NULL, merchant_id BIGINT NOT NULL, balance INTEGER NOT NULL, count INTEGER NOT NULL, price NUMERIC(10, 2) NOT NULL, supply_price NUMERIC(10, 2) NOT NULL, product_id BIGINT NOT NULL, provider_id BIGINT NOT NULL, close BOOLEAN NOT NULL, PRIMARY key (id));
CREATE TABLE cshop.role (id BIGINT NOT NULL, name CHARACTER VARYING(32) NOT NULL, PRIMARY key (id));
CREATE TABLE cshop.user (id BIGSERIAL NOT NULL, confirm BOOLEAN NOT NULL, email CHARACTER VARYING(320) NOT NULL, password CHARACTER VARYING(60) NOT NULL, role_id INTEGER NOT NULL, person_id BIGINT, PRIMARY key (id));
...
ALTER TABLE IF EXISTS cshop.supply ADD CONSTRAINT fk_supply_merchant_id FOREIGN key (merchant_id) REFERENCES cshop.user;
ALTER TABLE IF EXISTS cshop.user ADD CONSTRAINT fk_user_person_id FOREIGN key (person_id) REFERENCES cshop.person;
ALTER TABLE IF EXISTS cshop.user ADD CONSTRAINT fk_user_role_id FOREIGN key (role_id) REFERENCES cshop.role;
